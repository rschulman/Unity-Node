(function() {
  ...
  Level = (function() {
    ...
    Level.prototype.povObject = function(id) {
      var centerx, centery, checking, directionx, directiony, dist, elements, item, nextinrayx, nextinrayy, presensecheck, radian, subject, targetid, vision, wallbug, xmove, ymove;
      vision = 8;
      radian = 0;
      subject = players[id];
      elements = {
